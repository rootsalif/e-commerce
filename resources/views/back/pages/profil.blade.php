@extends('back.layout.profil-artisan-layout')
...
@section('contentProfil')
    ...
    >   
        ...
        <form action="{{route('home.updated', ['id'=>$id, 'dataUser'=>$table])}}" method="POST">
        @csrf
        @method('put')
                ...
                <ul class="profile-edit-list row">
                    <li class="weight-500 col-md-8">
                        ...
                        <div class="form-group">
                            <label>Genre</label>
                            <div>
                                <select class="form-control selectpicker" name="genre">
