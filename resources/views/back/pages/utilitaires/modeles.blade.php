...
@section('pageTitle', isset($pageTitle)? $pageTitle: 'Modeles d\'Article')
@section('content')
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">La gestion de modeles des l'articles</h4>
                        <p class="mb-30">Ajouter une modele</p>
                    </div>
                </div>
                <form action="{{ route('home.addUtil', ['utils'=>'modeles']) }}" method="POST">                    
                    @csrf
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">Table des modeles et leurs Modification|Supression </h4>
                </div>
                <div class="pb-20">
                    <table
                    ...
                    >
                        ...
                        <tbody>
                            @forelse ($modeles as $modele)
                                ...
                                <tr>                                       
                                    <td class="table-plus">{{ $modele->nom_modele }}</td>
                                    <td>{{ $modele->created_at }}</td>
                                    
                                    <td>
                                        <div class="table-actions">
                                            
                                                <a href="{{ route('home.editUtil', ['utils'=>'modeles', 'id'=>$modele->id]) }}" data-color="#265ed7"
                                                    ><button type="submit" class="btn btn-warning">Editer</button></a>
                                            
                                            <form action="{{ route('home.deleteUtil',['utils'=>'modeles', 'id'=>$modele->id]) }}" method="POST">
                                                @csrf
                                                @method('delete')
