    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">La gestion de familles des l'articles</h4>
                        <p class="mb-30">Ajouter une Famille</p>
                    </div>
                </div>
                <form action="{{ route('home.addUtil', ['utils'=>'familles']) }}" method="POST">                    
                    @csrf
                    ...
                    >
                        ...
                        <tbody>
                            @forelse ($familles as $famille)
                                ...
                                <tr>                                       
                                    <td class="table-plus">{{ $famille->nom_famille }}</td>
                                    <td>{{ $famille->created_at }}</td>
                                    
                                    <td>
                                        <div class="table-actions">
                                            
                                                <a href="{{ route('home.editUtil', ['utils'=>'familles', 'id'=>$famille->id]) }}" data-color="#265ed7"
                                                    ><button type="submit" class="btn btn-warning">Editer</button></a>
                                            
                                            <form action="{{ route('home.deleteUtil',['utils'=>'familles', 'id'=>$famille->id]) }}" method="POST">
                                                @csrf
                                                @method('delete')
