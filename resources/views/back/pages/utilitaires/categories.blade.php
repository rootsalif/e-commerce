...
@section('pageTitle', isset($pageTitle)? $pageTitle: 'categories d\'Article')
@section('content')
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">La gestion de categories des l'articles</h4>
                        <p class="mb-30">Ajouter une categorie</p>
                    </div>
                </div>
                <form action="{{ route('home.addUtil', ['utils'=>'categories']) }}" method="POST">                    
                    @csrf
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-8 mt-2">
                                    <textarea class="form-control" name="desc" placeholder="Description de Categorie"></textarea>
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">Table des categories et leurs Modification|Supression </h4>
                </div>
                <div class="pb-20">
                    <table
                    ...
                    >
                        ...
                        <tbody>
                            @forelse ($categories as $categorie)
                                ...
                                <tr>                                       
                                    <td class="table-plus">{{ $categorie->nom_categorie }}</td>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                                ...
                                                <a href="{{ route('home.editUtil', ['utils'=>'categories', 'id'=>$categorie->id]) }}" data-color="#265ed7"
                                                    ><button type="submit" class="btn btn-warning">Editer</button></a>
                                            
                                            <form action="{{ route('home.deleteUtil',['utils'=>'categories', 'id'=>$categorie->id]) }}" method="POST">
                                                @csrf
                                                @method('delete')
