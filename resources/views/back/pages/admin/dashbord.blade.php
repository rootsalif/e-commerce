...
@section('pageTitle', isset($pageTitle)? $pageTitle: 'Tableau de Bord Admin')
@section('content')
<div class="mobile-menu-overlay"></div>

			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0">APERÇU DE E-COMMERCE</h2>
				</div>
				...
				<div class="row pb-10">
						...
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark">77</div>
					...
					<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
						...
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark">{{$artisans->count()}}</div>
									<div class="font-14 text-secondary weight-500">
										Total Des Artisan
									</div>
								</div>
					...
					<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
						...
						<div class="card-box height-100-p widget-style3">
							<div class="d-flex flex-wrap">
								<div class="widget-data">
									<div class="weight-700 font-24 text-dark">{{$articles->count()}}</div>
									<div class="font-14 text-secondary weight-500">Total Des Articles</div>
								</div>
								<div class="widget-icon">
				...
				{{-- <div class="row pb-10">
					<div class="col-md-8 mb-20">
						<div class="card-box height-100-p pd-20">
							...
							>
								<div class="h5 mb-md-0">Activiter de Commerce</div>
					...
					<div class="col-md-4 mb-20">
						...
						>
							<div class="d-flex justify-content-between pb-20 text-white">
								...
								<div class="font-14 text-right">
									...
									<div class="font-12">Depuis le mois dernier</div>
								</div>
							</div>
							<div class="d-flex justify-content-between align-items-end">
								<div class="text-white">
									<div class="font-14">Rende-vous de Livraison</div>
						...
						<div class="card-box min-height-200px pd-20" data-bgcolor="#265ed7">
							...
							<div class="d-flex justify-content-between align-items-end">
								<div class="text-white">
									<div class="font-14">Livraison Faite</div>
				...
				<div class="card-box pb-10">
					<div class="h5 pd-20 mb-0">Artisans Recent</div>
						...
						<table class="data-table table nowrap">
							...
							<tbody>
								...
								<tr>
									<td class="table-plus">
										<a href="{{route('home.showArtisan', ['artisan'=>$artisan->id])}}">
											<div class="name-avatar d-flex align-items-center">
												...
												<div class="txt">
													<div class="weight-600">{{$artisan->nom_artisan}}</div>
												</div>
											</div>
										</a>
									</td>
									...
									<td>{{$artisan->date_naiss_artisan}}</td>
									<td>{{$artisan->profession_artisan}}</td>
										...
										<div class="table-actions">
											...
											<form action="{{route('home.destroy', ['artisan'=>$artisan->id])}}" method="POST">
												...
												<button type="submit" data-color="#e95959">
													<i class="icon-copy dw dw-delete-3">del</i>
												</button>
											</form>
										</div>
									</td>
