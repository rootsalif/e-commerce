...
<html>
	...
	@if(request()->is('admin/home/dashbord'))
								...
								<ul>
									...
									<li>
										<a href="#">
											...
											<p>
												C'est Important de prendre soin du patient, le patient sera suvi, mai ...
											</p>
										</a>
									</li>
								</ul>
				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						...
						>
							...
							<span class="user-name">{{Auth::user()->nom_admin}}</span>
						</a>
						<div
						...
						> 
							...
							<a class="dropdown-item" href="{{route('home.profilAdmin',['admin'=>Auth::user()->id])}}"
							...
							<form id="logout-form" action="{{ route('logout') }}" method="POST">
								...
								<a class="dropdown-item" href="{{ route('login') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
									<i id="logout" class="dw dw-logout"></i>	Se deconnecter
								</a>
							</form>
		...
		<div class="right-sidebar">
			...
			<div class="right-sidebar-body customscroll">
				<div class="right-sidebar-body-content">
					<h4 class="weight-600 font-18 pb-10">Couleur Arrière-plan</h4>
					...
					<h4 class="weight-600 font-18 pb-10">Menu Icon</h4>
					...
					<h4 class="weight-600 font-18 pb-10">Menu Liste Icon</h4>
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li class="dropdown">
							<a href="{{route('home.dashbord')}}" class="dropdown-toggle no-arrow">
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								><span class="mtext">Compte Admin</span>
							</a>
							<ul class="submenu">
								<li><a href="{{route('home.profilAdmin',['admin'=>Auth::user()->id])}}">Profile</a></li>
								<li>
						...
						{{-- Compte Artisans --}}
						<li class="dropdown">
							<a href="{{ route('home.dataArtisan') }}" class="dropdown-toggle no-arrow">
								<span class="micon dw dw-user2"></span
								><span class="mtext">Artisans</span>
							</a>							
						</li>

						{{-- Compte Client --}}
						<li class="dropdown">
							<a href="{{ route('home.dataClient') }}" class="dropdown-toggle no-arrow">
								<span class="micon dw dw-user"></span
								><span class="mtext">Clients</span>
							</a>							
						</li>

						{{-- Les table de article --}}
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								<span class="micon bi bi-textarea-resize"></span
								><span class="mtext">Aticles</span>
							</a>
							<ul class="submenu child">	
								<li><a href="{{ route('home.util', ['utils'=>'categories']) }}">Categories</a></li>									
								<li><a href="{{ route('home.util', ['utils'=>'familles']) }}">Familles</a></li>
								<li><a href="{{ route('home.util', ['utils'=>'modeles']) }}">Modeles</a></li>
								<li><a href="{{ route('home.util', ['utils'=>'marques']) }}">Marques</a></li>
								<li><a href="{{ route('home.util', ['utils'=>'etats']) }}">Etats</a></li>	
								<li><a href="{{ route('home.util', ['utils'=>'couleurs']) }}">Couleurs</a></li>	
								<li><a href="{{ route('home.util', ['utils'=>'sous-categories']) }}">Sous Categories</a></li>
																			
							</ul>
						</li>
						{{-- Commande --}}
						<li class="dropdown">
							<a href="{{ route('home.util', ['utils'=>'commandes']) }}" class="dropdown-toggle no-arrow">
						...
						<li>
							<div class="sidebar-small-cap">Plus D'information</div>
						</li>
						<li>
								...
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										<li class="breadcrumb-item">
											<a href="{{ route('home.dashbord') }}">Accueil</a>
										</li>
